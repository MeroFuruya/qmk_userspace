...
#define FN_MAC MO(LAYER_MAC_FN)
#define FN_WIN MO(LAYER_WIN_FN)

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_MAC_BASE] = LAYOUT_iso_83(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
  [LAYER_MAC_BASE] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
  [LAYER_MAC_FN]   = {ENCODER_CCW_CW(UG_VALD, UG_VALU)},
  [LAYER_WIN_BASE] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
  [LAYER_WIN_FN]   = {ENCODER_CCW_CW(UG_VALD, UG_VALU)},
};
